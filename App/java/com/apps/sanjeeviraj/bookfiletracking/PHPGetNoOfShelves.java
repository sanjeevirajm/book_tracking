...
public class PHPGetNoOfShelves  extends AsyncTask<String,Void,String>{

    private Context context;
    public String IP, link, rack_no;
    public String result = null;
    public static int shelf_no = -1;

    public PHPGetNoOfShelves(Context context) {
    ...
    protected String doInBackground(String... arg0) {
        try{
            ...
            link="http://"+IP+"/book_tracking/book_add/get_no_of_shelves.php";
            ...
            try {
                result = result.trim();
                shelf_no = Integer.parseInt(result);
            }
            catch (Exception e)
            {
    ...
    protected void onPostExecute(String result){
        if(shelf_no == 0) {
            Toast.makeText(context, "Enter no of shelves", Toast.LENGTH_SHORT).show();

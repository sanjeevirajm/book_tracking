...
public class SearchActivity extends AppCompatActivity {
    ...
    public void bookid_function(View v)
    {
        flag_bookid_barqrcode = 1;
        Intent bookid_intent = new Intent(this,SearchBookIDActivity.class);
        startActivity(bookid_intent);
    }

    public void others_function(View v)
    {
        flag_bookid_barqrcode = 3;
        Intent others_intent = new Intent(this,SearchBookDetails.class);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        if (requestCode == 0) {
            if (resultCode == RESULT_OK) {
                ...
                Intent modify_details_intent = new Intent(this, SearchShowBookDetailsActivity.class);

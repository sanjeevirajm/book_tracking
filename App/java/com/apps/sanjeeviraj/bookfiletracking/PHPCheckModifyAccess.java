...
public class PHPCheckModifyAccess  extends AsyncTask<String,Void,String> {
    ...
    public PHPCheckModifyAccess(Context context) {
    ...
    protected String doInBackground(String... arg0) {
        try{
            ...
            link="http://"+IP+"/book_tracking/modify/get_permission.php";
    ...
    private void openModifyActivity() {
        try {
            ...
            Intent modify_intent = new Intent(context, ModifyActivity.class);
            Log.v("myapp", " before startActivity ");

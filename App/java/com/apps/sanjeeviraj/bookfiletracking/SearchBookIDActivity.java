...
public class SearchBookIDActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_book_id);
   //     Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
    ...
    public void showBookDetails(View v)
    {
        ...
        Intent showBookDetails = new Intent(this, SearchShowBookDetailsActivity.class);
    ...
    {
        Intent cancelIntent = new Intent(this, SearchActivity.class);

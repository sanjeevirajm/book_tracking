...
public class PHPCheckBookAddAccess  extends AsyncTask<String,Void,String>{
    ...
    public PHPCheckBookAddAccess(Context context) {
    ...
    protected String doInBackground(String... arg0) {
        try{
            ...
            link="http://"+IP+"/book_tracking/book_add/get_permission.php";
    ...
    private void openBookAddActivity() {
        try {
            Log.v("myapp", " inside open rack add function ");
            Intent book_add_intent = new Intent(context, BookAddActivity.class);
            Log.v("myapp", " before startActivity ");
            book_add_intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            context.startActivity(book_add_intent);
            Log.v("myapp", " after startActivity ");
        }
        catch (Exception e) {
            Log.v("myapp", " after startActivity exception " +e);

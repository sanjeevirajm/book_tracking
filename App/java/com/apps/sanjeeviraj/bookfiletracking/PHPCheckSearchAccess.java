...
public class PHPCheckSearchAccess  extends AsyncTask<String,Void,String> {
    ...
    public PHPCheckSearchAccess(Context context) {
    ...
    protected String doInBackground(String... arg0) {
        try{
            ...
            link="http://"+IP+"/book_tracking/search/get_permission.php";
    ...
    private void openSearchActivity() {
        try {
            ...
            Log.v("myapp", " before startActivity ");
            search_intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            context.startActivity(search_intent);
            Log.v("myapp", " after startActivity ");
        }
        catch (Exception e) {
            Log.v("myapp", " after startActivity exception " +e);

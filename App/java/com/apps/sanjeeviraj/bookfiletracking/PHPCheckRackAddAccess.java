...
public class PHPCheckRackAddAccess  extends AsyncTask<String,Void,String>{
    ...
    public PHPCheckRackAddAccess(Context context) {
    ...
    protected String doInBackground(String... arg0) {
        try{
            ...
            link="http://"+IP+"/book_tracking/rack_add/get_permission.php";
    ...
    private void openRackAddActivity() {
        try {
            Log.v("myapp", " inside open rack add function ");
            Intent rack_add_intent = new Intent(context, RackAddActivity.class);
            Log.v("myapp", " before startActivity ");
            rack_add_intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            context.startActivity(rack_add_intent);
            Log.v("myapp", " after startActivity ");
        }
        catch (Exception e) {
            Log.v("myapp", " after startActivity exception " +e);

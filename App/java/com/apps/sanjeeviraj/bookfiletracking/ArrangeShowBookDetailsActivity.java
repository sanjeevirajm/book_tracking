...
public class ArrangeShowBookDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        try
        {
            ...
            setContentView(R.layout.activity_arrange_show_book_details);
    ...
    public void startProgram() {
        try {
                ...
                while (flag_bar_qr == 0)
                    flag_bar_qr = ArrangeScanActivity.flag_bar_qr;
                while (book_id == 0)
                    book_id = ArrangeScanActivity.book_id;

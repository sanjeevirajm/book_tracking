...
public class PHPModifyDetails  extends AsyncTask<String,Void,String>{
    ...
    public PHPModifyDetails(Context context) {
    ...
    protected String doInBackground(String... arg0) {
        try{
            ...
            if(flag_bar_qr == 1)
                link="http://"+IP+"/book_tracking/modify/bar_book_add.php";
            else
                link="http://"+IP+"/book_tracking/modify/qr_book_add.php";
    ...
    private void openPreviousActivity() {
        try {
            ...
            Intent previous_intent = new Intent(context, ModifyBookID.class);
